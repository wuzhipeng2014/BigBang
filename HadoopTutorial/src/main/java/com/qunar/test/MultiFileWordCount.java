...
/**
 * Created by zhipengwu on 18-1-8.
 */
public class MultiFileWordCount extends Configured implements Tool {
    ...
    /**
     * To use {@link CombineFileInputFormat}, one should extend it, to return a (custom) {@link RecordReader}.
     * CombineFileInputFormat uses {@link CombineFileSplit}s.
     */
    public static class MyInputFormat extends CombineFileInputFormat<WordOffset, Text> {

        public RecordReader<WordOffset, Text> createRecordReader(InputSplit split, TaskAttemptContext context)
                throws IOException {
            return new CombineFileRecordReader<WordOffset, Text>((CombineFileSplit) split, context,
    ...
    /**
     * This Mapper is similar to the one in {@link }.
     */
