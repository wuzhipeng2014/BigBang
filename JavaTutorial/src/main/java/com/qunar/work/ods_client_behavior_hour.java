...
public class ods_client_behavior_hour {
    ...
    public static void main(String[] args) {
        ...
        String filename = "adrHOMEPAGE_MODULE_SHOW_bn39sa_START20170302";
//        String filename = "iosHOMEPAGE_MODULE_SHOW_bn39sa_START20170228";


        String inputFilename = baseDir + "input/ods_client_behavior_client_hour/"+filename;
...
//                }
        ...
        System.out.println("####countcuid:"+countCuid);
